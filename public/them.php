...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$product->fill($_POST, $_FILES); // $_FILE lấy hình ảnh.
	if ($product->validate()) {
		$product->save() && redirect('quantri.php');
	}
        ...
        <div class="container py-5">
            <div class="mb-3">
                <h5>
                    ...
                    <i class="fa-solid fa-chevron-right"></i>
                    <a href="them.php" style="text-decoration: none; color:#bfbfbf;">Thêm Sản Phẩm</a>
                </h5>
            </div>
            ...
            <div class="rounded-2" style="width: 1295px; background-color: #D4ECF4; color: #000;">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="card-title text-center">THÊM SẢN PHẨM</h4>
                    </div>
                    <hr>
